...
import 'package:tiaa/Screens/NavBar/News/NewsCard.dart';
import 'package:tiaa/Models/NewsModel.dart';
...
class _FlutterNewsState extends State<FlutterNews> {
  Future<NewsModel> getNewsApi() async {
    final response = await http.get(Uri.parse(
        'https://newsapi.org/v2/everything?q=sensex&sortBy=publishedAt&apiKey=fc2027239c6e4cb9ae3989f79e5f476d'));
